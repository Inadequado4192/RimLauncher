...
import { Box, CircularProgress, ColorPaletteProp, DialogContent, DialogTitle, Dropdown, List, ListDivider, ListItem, Menu, MenuButton, MenuItem, Modal, ModalDialog, Sheet, Stack, Table, Tooltip, Typography } from "@mui/joy";
import React from "react";
import { MainBody } from "../Parts";
import { set } from "zod";
...
export default function MyltiplayerCompabilityDialog() {
    ...
    React.useEffect(() => {
        ...
        const API_KEY = "AIzaSyAfkkorXcYbJjda1A6FNt5pGSu0Cu1A35E";
